    ...
    def _ensure(self):
        ...
        if not self.config_path.exists():
            self.config_path.write_text(json.dumps({
                ...
                "kws_enabled": True,
                "kws_provider": "sherpa",
                "sherpa_model_dir": "./sherpa",
                "sherpa_keywords_file": "keywords.txt",
                "sherpa_tokens_path": "tokens.txt",
                "sherpa_encoder_path": "encoder-epoch-12-avg-2-chunk-16-left-64.int8.onnx",
                "sherpa_decoder_path": "decoder-epoch-12-avg-2-chunk-16-left-64.int8.onnx",
                "sherpa_joiner_path": "joiner-epoch-12-avg-2-chunk-16-left-64.int8.onnx",
